...
public class BlockCondenser extends BlockContainer
{
    ...
    public BlockCondenser(int par1, int par2)
    {
    ...
    {
        TileEntityCondenser var7 = (TileEntityCondenser)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        Object object = (TileEntityCondenser)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("Tutorial Large Chest", (TileEntityCondenser)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)object);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("Tutorial Large Chest", (IInventory)object, (TileEntityCondenser)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                object = new InventoryLargeChest("Tutorial Large Chest", (TileEntityCondenser)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)object);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                object = new InventoryLargeChest("Tutorial Large Chest", (IInventory)object, (TileEntityCondenser)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
    ...
    {
    	TileEntityCondenser tileentitychest = new TileEntityCondenser();
