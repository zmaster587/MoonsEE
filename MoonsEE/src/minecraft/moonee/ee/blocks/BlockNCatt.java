...
public class BlockNCatt extends Block
{
    public BlockNCatt(int par1, int par2)
    {
    ...
    public void onBlockDestroyedByExplosion(World par1World, int par2, int par3, int par4)
    {
        ...
        {
            EntityNCattPrimed var5 = new EntityNCattPrimed(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F));
    ...
    public void onBlockDestroyedByPlayer(World par1World, int par2, int par3, int par4, int par5)
    {
        if (!par1World.isRemote)
        {
            if ((par5 & 1) == 1)
            {
                EntityNCattPrimed var6 = new EntityNCattPrimed(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F));
