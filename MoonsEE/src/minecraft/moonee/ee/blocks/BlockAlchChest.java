...
public class BlockAlchChest extends BlockContainer
{
    private final Random random = new Random();
    public final int field_94443_a;

    public BlockAlchChest(int par1, int par2)
    {
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        TileEntityAlchChest tileentitychest = (TileEntityAlchChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        TileEntityAlchChest var7 = (TileEntityAlchChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    player.openGui(mod_EE.instance, 0, world, x, y, z);
            return true;
    }
    ...
    {
        Object object = (TileEntityAlchChest)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("Tutorial Large Chest", (TileEntityAlchChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)object);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("Tutorial Large Chest", (IInventory)object, (TileEntityAlchChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                object = new InventoryLargeChest("Tutorial Large Chest", (TileEntityAlchChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)object);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                object = new InventoryLargeChest("Tutorial Large Chest", (IInventory)object, (TileEntityAlchChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
    ...
    {
    	TileEntityAlchChest tileentitychest = new TileEntityAlchChest();
