...
public class TileEntityCondenser extends TileEntity implements IInventory
{
    ...
    public TileEntityCondenser adjacentChestZNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityCondenser adjacentChestXPos;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityCondenser adjacentChestXNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityCondenser adjacentChestZPosition;
    ...
    private void func_90009_a(TileEntityCondenser par1TileEntityChest, int par2)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityCondenser)this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityCondenser)this.worldObj.getBlockTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityCondenser)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPosition = (TileEntityCondenser)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_94044_a(int par1, int par2, int par3)
    {
        ...
        return block != null && block instanceof BlockCondenser ? ((BlockCondenser)block).field_94443_a == this.func_98041_l() : false;
    }
    ...
    public int func_98041_l()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof BlockCondenser))
            {
                return 0;
            }

            this.field_94046_i = ((BlockCondenser)this.getBlockType()).field_94443_a;
        }
