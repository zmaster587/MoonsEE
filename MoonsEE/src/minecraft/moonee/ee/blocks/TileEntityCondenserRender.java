...
public class TileEntityCondenserRender extends TileEntitySpecialRenderer
{
    ...
    public TileEntityCondenserRender()
    {
     ...
     */
    public void renderTileEntityChestAt(TileEntityCondenser par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int var9;
        ...
        else
        {
            ...
            if (var10 != null && var9 == 0)
            {
                try
                {
                    ((BlockCondenser)var10).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
        ...
        if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null)
        {
            ...
            if (par1TileEntityChest.adjacentChestXPos == null && par1TileEntityChest.adjacentChestZPosition == null)
            {
                ...
                {
                    this.bindTextureByName("/moonee/ee/art/sprites/condenser.png");
                }
                else
                {
                    this.bindTextureByName("/moonee/ee/art/sprites/condenser.png");
    ...
    {
        this.renderTileEntityChestAt((TileEntityCondenser)par1TileEntity, par2, par4, par6, par8);
    }
}
