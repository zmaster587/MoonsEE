...
public class BlockNCatm extends Block
{
    public BlockNCatm(int par1, int par2)
    {
    ...
    public void onBlockDestroyedByExplosion(World par1World, int par2, int par3, int par4)
    {
        ...
        {
            EntityNCatmPrimed var5 = new EntityNCatmPrimed(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F));
    ...
    public void onBlockDestroyedByPlayer(World par1World, int par2, int par3, int par4, int par5)
    {
        if (!par1World.isRemote)
        {
            if ((par5 & 1) == 1)
            {
                EntityNCatmPrimed var6 = new EntityNCatmPrimed(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F));
