...
public class TileEntityDMFurnace extends TileEntity implements IInventory, ISidedInventory
{
    /**
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                var2 = true;
                BlockDMFurnace.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
